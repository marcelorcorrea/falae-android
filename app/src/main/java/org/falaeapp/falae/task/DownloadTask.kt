...
// */
//
//class DownloadTask(val context: WeakReference<Context>, private val downloadCacheDao: DownloadCacheDao, private val onSyncComplete: (user: User) -> Unit) : AsyncTask<User, Void, User>() {
